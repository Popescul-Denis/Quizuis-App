      ...
      <div className="how_to_start_section">
        ...
        <div className="flex flex-row">
          <div className="step_1">
            <p className="step_1_text text-lg text-gray-600 mb-2"><span className="font-bold text-xl">Pasul 1:</span> Creeaza un <span className="font-bold cursor-pointer text_span" onClick={() => {router.push('/sign-up')}}>cont nou</span> sau <span className="font-bold cursor-pointer text_span" onClick={() => {router.push('/log-in')}}>logheaza-te</span> cu unul existent</p>
          </div>
          <div className="step_2">
            <p className="step_2_text text-lg text-gray-600 mb-2"><span className="font-bold text-xl">Pasul 2:</span> Exploreaza multitudinea de quiz-uri disponibile si testeaza-ti cunostintele</p>
          </div>
        </div>
        <div className="step_3">
          <p className="step_3_text text-lg text-gray-600 mb-2"><span className="font-bold text-xl">Pasul 3:</span> Creeaza-ti propriile quiz-uri unice și împărtășește-le cu prietenii tăi!</p>
        </div>
